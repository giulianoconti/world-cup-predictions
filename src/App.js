...
function App() {
  ...
  return (
    <div className="App">
      <h1>Catar 2022</h1>
      <div className='all-groups' onClick={e => (e.target.id === 'A1' || e.target.id === 'A11' || e.target.id === 'A111' || e.target.id === 'A1111' ||
        e.target.id === 'A2' || e.target.id === 'A22' || e.target.id === 'A222' || e.target.id === 'A2222' || e.target.id === 'A3' || e.target.id === 'A33' || e.target.id === 'A333' || e.target.id === 'A3333' || e.target.id === 'A4' || e.target.id === 'A44' || e.target.id === 'A444' || e.target.id === 'A4444' || e.target.id === 'B1' || e.target.id === 'B11' || e.target.id === 'B111' || e.target.id === 'B1111' ||
        e.target.id === 'B2' || e.target.id === 'B22' || e.target.id === 'B222' || e.target.id === 'B2222' || e.target.id === 'B3' || e.target.id === 'B33' || e.target.id === 'B333' || e.target.id === 'B3333' || e.target.id === 'B4' || e.target.id === 'B44' || e.target.id === 'B444' || e.target.id === 'B4444' || e.target.id === 'C1' || e.target.id === 'C11' || e.target.id === 'C111' || e.target.id === 'C1111' ||
        e.target.id === 'C2' || e.target.id === 'C22' || e.target.id === 'C222' || e.target.id === 'C2222' || e.target.id === 'C3' || e.target.id === 'C33' || e.target.id === 'C333' || e.target.id === 'C3333' || e.target.id === 'C4' || e.target.id === 'C44' || e.target.id === 'C444' || e.target.id === 'C4444' || e.target.id === 'D1' || e.target.id === 'D11' || e.target.id === 'D111' || e.target.id === 'D1111' ||
        e.target.id === 'D2' || e.target.id === 'D22' || e.target.id === 'D222' || e.target.id === 'D2222' || e.target.id === 'D3' || e.target.id === 'D33' || e.target.id === 'D333' || e.target.id === 'D3333' || e.target.id === 'D4' || e.target.id === 'D44' || e.target.id === 'D444' || e.target.id === 'D4444' || e.target.id === 'E1' || e.target.id === 'E11' || e.target.id === 'E111' || e.target.id === 'E1111' ||
        e.target.id === 'E2' || e.target.id === 'E22' || e.target.id === 'E222' || e.target.id === 'E2222' || e.target.id === 'E3' || e.target.id === 'E33' || e.target.id === 'E333' || e.target.id === 'E3333' || e.target.id === 'E4' || e.target.id === 'E44' || e.target.id === 'E444' || e.target.id === 'E4444' || e.target.id === 'F1' || e.target.id === 'F11' || e.target.id === 'F111' || e.target.id === 'F1111' ||
        e.target.id === 'F2' || e.target.id === 'F22' || e.target.id === 'F222' || e.target.id === 'F2222' || e.target.id === 'F3' || e.target.id === 'F33' || e.target.id === 'F333' || e.target.id === 'F3333' || e.target.id === 'F4' || e.target.id === 'F44' || e.target.id === 'F444' || e.target.id === 'F4444' || e.target.id === 'G1' || e.target.id === 'G11' || e.target.id === 'G111' || e.target.id === 'G1111' ||
        e.target.id === 'G2' || e.target.id === 'G22' || e.target.id === 'G222' || e.target.id === 'G2222' || e.target.id === 'G3' || e.target.id === 'G33' || e.target.id === 'G333' || e.target.id === 'G3333' || e.target.id === 'G4' || e.target.id === 'G44' || e.target.id === 'G444' || e.target.id === 'G4444' || e.target.id === 'H1' || e.target.id === 'H11' || e.target.id === 'H111' || e.target.id === 'H1111' ||
        e.target.id === 'H2' || e.target.id === 'H22' || e.target.id === 'H222' || e.target.id === 'H2222') && selectedGroupRanking(e.nativeEvent.path[2].cells[0].innerHTML, e.target.id)}>
        {
          groups.map(group => {
            return (
